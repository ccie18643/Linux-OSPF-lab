...
2. Edit configuration of new VM (using 'virsh edit r1' command) and change the name of interface from 'template-router' to 'r1'. This step is important as you really want to be able to easilly distinguish between your virtual router interfaces when using Wireshark.
...
6. At this point we are done with r1, i have also configured r2 and r3 to show the OSPF peerings forming up.
